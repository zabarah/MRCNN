...
def net_MRCNN(x, y, keep_prob):
 W_conv1 = weight_variable([1, 4, 1, 16])
 b_conv1 = bias_variable([16])
 h_conv1 = tf.nn.conv2d(x, W_conv1, strides=[1,1,4,1], padding='VALID') + b_conv1
 ...
 equal = tf.equal(tf.round(y_conv), tf.round(y))
